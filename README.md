# Welcome to the Economics Research Guide documentation
...
#### [Economics Research Guide Details Page](https://www.gitbook.com/book/broome-library/economics-guide/details)
> The details page is the landing page for the Economics Research Guide GitBook.  It displays the introduction as well as provides links to edit the settings or the book pages if logged in.

#### [Economics Research Guide Content URL](https://broome-library.gitbooks.io/economics-guide/content)
...
#### https
https://github.com/broome-library/economics-guide.git

#### ssh
```git@github.com:broome-library/economics-guide.git```
